  ...
  return [
    {
      ...
      features: ["Open docs", "Local checks", "Community access"],
      mode: "community",
      ctaLabel: "Start Free",
      ctaHref: "/docs",
    },
    {
      ...
      features: ["Drift timeline", "License Hub", "Billing visibility"],
      mode: "self_serve",
    ...
    },
    {
      ...
      features: ["Drift compare", "Assoc correlate", "Higher tier"],
      mode: "self_serve",
    ...
    },
    {
      ...
      features: ["Contact-led buying", "Procurement support", "Custom review"],
      mode: "contact",
      ctaLabel: "Contact Sales",
      ctaHref: "/contact",
    },
