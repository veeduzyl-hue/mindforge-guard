  ...
  return [
    {
      ...
      eyebrow: "",
      priceLabel: "Free",
      summary: "See current governance evidence for one local single-agent workflow.",
      features: [
        "Local CLI evaluation",
        "Current-state governance evidence",
        "Audit, permit, classify, drift status, and license lifecycle commands",
      ],
      mode: "community",
      ctaLabel: "Read docs",
    ...
    },
    {
      ...
      summary: "Track governance signals over time for AI-assisted work.",
      features: [
        "Everything in Community",
        "Timeline-oriented governance review where released commands support it",
        "Signed license delivery through License Hub",
        "Local CLI behavior remains license-file based",
      ],
      mode: "self_serve",
    ...
    },
    {
      ...
      eyebrow: "",
      priceLabel: "Monthly / yearly",
      summary: "Compare evidence states and uncover deeper governance signals.",
      features: [
        "Everything in Pro",
        "Compare-oriented review where released commands support it",
        "Correlation-oriented signals where released commands support it",
        "Built for teams that need deeper review evidence before trust",
      ],
      mode: "self_serve",
    ...
    },
    {
      ...
      summary: "Standardize procurement, rollout, and review packets around the same bounded runtime posture.",
      features: [
        "Procurement, legal, and rollout support",
