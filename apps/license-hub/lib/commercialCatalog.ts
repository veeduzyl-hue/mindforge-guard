  ...
  return [
    {
      ...
      eyebrow: "",
      priceLabel: "Free",
      summary: "Start with the local baseline for AI-assisted governance review.",
      features: [
        "Use the Community edition with the local Guard CLI",
        "Audit, permit, and classify behavior stays local and unchanged",
        "Use the public docs and evaluation materials",
      ],
      mode: "community",
      ctaLabel: "Read docs",
    ...
    },
    {
      ...
      summary: "For individuals and small teams that need commercial licensing, signed delivery, and ongoing account visibility.",
      features: [
        "Signed license delivery through License Hub",
        "License Hub visibility for orders, billing state, and license downloads",
    ...
    },
    {
      ...
      eyebrow: "",
      priceLabel: "Monthly / yearly",
      summary: "For teams that need the higher commercial tier and the full current paid analytics surface.",
      features: [
        "Includes Pro delivery and License Hub account visibility",
        "Built for teams that need the current Pro+ paid analytics surface",
