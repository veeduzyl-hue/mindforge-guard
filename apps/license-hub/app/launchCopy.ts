...
export const faqItems = [
  ...
  },
  {
    ...
    answer: "Choose Pro or Pro+ on Pricing, then use the purchase email to sign in to License Hub.",
  },
  {
...
export const boundarySummary =
  "MindForge Guard remains recommendation-only, additive-only, non-executing, and local-first. License Hub supports purchase, billing, and signed license delivery without changing Guard CLI semantics.";
...
export const releaseAnnouncement = {
  ...
  bullets: [
    ...
    "Buy through License Hub and install the signed license locally",
  ],
} as const;
