...
export default function SupportPage() {
  const supportAreas = [
    ...
    },
    {
      ...
      body: "Help with Customer Portal login, signed license download, billing state visibility, or account access.",
    },
    {
      title: "Local install",
  ...
  return (
    <SiteChrome
      ...
      lede="Support covers purchase questions, Customer Portal access, signed license delivery, and local license installation guidance."
