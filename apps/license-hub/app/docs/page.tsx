...
export default function DocsPage() {
  return (
    <SiteChrome
      ...
      lede="Product docs explain MindForge Guard. Licensing Center docs explain purchase, signed license delivery, and Customer Portal access."
    ...
    >
      <section style={{ ...panelStyle, display: "grid", gap: 14 }}>
        ...
        <div style={{ display: "grid", gap: 12, gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))" }}>
          ...
          <article style={{ display: "grid", gap: 8, padding: 16, border: "1px solid #d8ccae", borderRadius: 12 }}>
            <strong>FAQ and Customer Portal</strong>
            <p style={{ margin: 0, color: "#5b5444", lineHeight: 1.6 }}>
              Use FAQ for buyer questions, then use the portal after purchase to view licenses and download signed JSON.
            </p>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
