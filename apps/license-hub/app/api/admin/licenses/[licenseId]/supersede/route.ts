...
import { supersedeLicenseByAdmin } from "../../../../../../lib/adminActions";
...
export async function POST(
  ...
  try {
    ...
    const result = await supersedeLicenseByAdmin({
      db,
      actorEmail: session.email,
      licenseId,
      notAfter: typeof body.notAfter === "string" ? body.notAfter : "",
    ...
    return respond(request, body, {
      ok: true,
      previousLicenseId: result.previousLicense.licenseId,
      replacementLicenseId: result.replacementLicense.licenseId,
      replacementEdition: result.replacementLicense.edition,
