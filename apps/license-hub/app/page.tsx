...
const trustDemoHelperCards = [
  ...
  },
  {
    ...
    body: "Follow the first-report path for a sample single-agent action without narrowing the story to one synthetic sample.",
    links: [
      {
  ...
  const afterPurchaseFlow = [
    {
      ...
      body: "Use the same purchase email to sign in to License Hub after checkout.",
    },
    {
    ...
    },
    {
      ...
      body: "Guard produces review evidence so the final human review decision stays outside Guard.",
    },
  ] as const;
  const purchaseFlow = [
    {
    ...
    <main style={pageBackgroundStyle}>
      <div style={{ maxWidth: 1120, margin: "0 auto", display: "grid", gap: 18 }}>
          ...
          <div style={{ display: "grid", gap: 12, gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))" }}>
            {afterPurchaseFlow.map((step) => (
              ...
              >
                ...
                {"body" in step ? (
                  <p style={{ ...mutedTextStyle, margin: 0 }}>{step.body}</p>
                ) : (
                  <pre
                    style={{
                      margin: 0,
        ...
        <section style={{ ...panelStyle, display: "grid", gap: 12 }}>
          ...
          <p style={{ ...mutedTextStyle, margin: 0 }}>
            Then follow the first report workflow in the docs. Guard remains recommendation-only, non-executing, non-control-plane, deterministic, and no extra runtime authority is added for Enterprise.
          </p>
        </section>
