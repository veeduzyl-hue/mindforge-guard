...
Guard is the first commercial product of the **MindForge CDS (Cognitive
Decision System)**.

It provides deterministic, offline governance for AI-native development
workflows.
...
Guard introduces a governance layer between AI-generated change and
