...
await import(
  "./verify_governance_case_review_decision_closure_evidence_package_delivery_manifest_acceptance_semantics_hardening.mjs"
);
...
function buildPackageFixture() {
  return {
    ...
    canonical_action_hash:
      "sha256:111122223333444455556666777788889999aaaabbbbccccddddeeeeffff6666",
...
for (const field of [
  ...
  if (
    ...
    throw new Error(
      `review decision closure evidence package delivery manifest acceptance semantics final acceptance drifted: ${field}`
    );
  }
}
...
for (const field of [
  ...
  if (validationExports[field] !== true) {
    throw new Error(
      `review decision closure evidence package delivery manifest acceptance semantics final acceptance validation export drifted: ${field}`
    );
  }
}
...
for (const field of [
  ...
  if (
    ...
    throw new Error(
      `review decision closure evidence package delivery manifest acceptance semantics final acceptance preserved semantic drifted: ${field}`
    );
  }
}
...
for (const field of [
  ...
  if (
    ...
    throw new Error(
      `review decision closure evidence package delivery manifest acceptance semantics final acceptance negative semantic drifted: ${field}`
    );
  }
}
