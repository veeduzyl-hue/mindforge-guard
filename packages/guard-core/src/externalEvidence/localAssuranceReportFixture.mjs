import { createAssuranceReportIntegrityReference } from "./localAssuranceReportIntegrity.mjs";
...
export function buildLocalAssuranceReportFixture(input) {
  ...
  if (fixtureInput.report_integrity !== undefined) {
    throw new TypeError(
  ...
  const provisionalAssuranceReport = {
    report_id: reportId,
    verification_id: verificationId,
  ...
  const assuranceReport = {
    ...provisionalAssuranceReport,
    report_integrity: createAssuranceReportIntegrityReference(
      provisionalAssuranceReport
    ),
  };
