# v5.1 Phase 2: Review Pack, Rationale Bundle, and Export Compatibility

Status: candidate in development

Scope:
- introduce `governance_review_pack_contract`
- introduce `governance_rationale_bundle_profile`
- introduce `governance_snapshot_export_compatibility_contract`
- freeze snapshot receipt-readiness and consumer compatibility surface
- preserve additive-only snapshot layer semantics
